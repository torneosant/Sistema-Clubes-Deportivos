...
class JugadorController extends Controller
{
    ...
    public function show(Jugador $jugador)
    {
        ...
        */
        ...
        $totalPendiente = $cargos
            ->whereNotIn('estado', ['Anulado', 'Exonerado'])
            ->sum(function ($cargo) {
        ...
        */
        ...
        $incapacidades = $asistencias
            ->where('estado', 'Incapacidad')
            ->count();
        ...
        */
        ...
        $partidosInicialista = PartidoJugador::where(
            'jugador_id',
            $jugador->id
        )
            ->where('titular', 1)
        ...
        $partidosSuplente = PartidoJugador::where(
            'jugador_id',
            $jugador->id
        )
            ->where('titular', 0)
            ->where('participacion', 'Suplente')
            ->count();
        ...
        */
        ...
        $detallePartidos = PartidoJugador::with([
                'partido.equipo',
                'partido.competencia'
            ])
            ->where('jugador_id', $jugador->id)
        ...
        */
        ...
        return view('jugadores.show', [
            ...
            'totalPagadoCargos' => $totalPagadoCargos,
            ...
            'partidosInicialista' => $partidosInicialista,
            'partidosSuplente' => $partidosSuplente,
    ...
    public function update(Request $request, Jugador $jugador)
    {
        ...
        if ($request->hasFile('foto')) {
            ...
            if (
                $jugador->foto &&
                Storage::disk('public')->exists($jugador->foto)
            ) {
