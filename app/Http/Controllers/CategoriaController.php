...
class CategoriaController extends Controller
{
    ...
    public function porEquipo(\App\Models\Equipo $equipo)
    {
        ...
        abort_unless(
            $equipo->club_id == $clubId,
            403,
            'No tiene permiso para consultar este equipo.'
        );
    ...
    /**
     * Verificar que la categoría pertenece al club del usuario.
     */
    private function verificarClub(Categoria $categoria): void
    {
        abort_unless(
            $categoria->club_id == auth()->user()->club_id,
            403,
            'No tiene permiso para consultar esta categoría.'
        );
    }
}